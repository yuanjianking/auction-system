...
(function ($) {
    ...
    $.fn.fileinputLocales['da'] = {
        ...
        cancelLabel: 'Fortryd',
        cancelTitle: 'Afbryd nuv&aelig;rende uploads',
        uploadLabel: 'Upload',
        ...
        msgFilesTooLess: 'Du skal mindst v&aelig;lge <b>{n}</b> {files} til uploads.',
        msgFilesTooMany: '<b>({n})</b> filer valgt til uploads, men maks. <b>{m}</b> er tilladt.',
